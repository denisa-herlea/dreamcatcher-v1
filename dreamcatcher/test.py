...
class ViewsTestCase(TestCase):
    ...
    def test_statistici_view_stres(self):
        self.client.login(username='test_admin', password='test_pass')
        response = self.client.get(reverse('dreamcatcher:statistici_view_stres'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'stres_chart.html')

    def test_statistici_view_energie(self):
        self.client.login(username='test_admin', password='test_pass')
        response = self.client.get(reverse('dreamcatcher:statistici_view_energie'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'energy_chart.html')
